describe('Scraper', function () {
	...
	it('should shorten image file name to 143 symbols', function () {
		...
		var image = Scraper.prototype.getFileFilename(
			'http://example.com/012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789'
		);
	...
	it('should store images while scraping', function () {
		$el.append(
			'<div id="scraper-test-img"><img src="../docs/images/chrome-store-logo.png"></div>'
		);
